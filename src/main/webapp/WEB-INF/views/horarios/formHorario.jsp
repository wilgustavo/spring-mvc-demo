...
<html lang="en">
    ...
    <spring:url value="/horarios/" var="urlHorario"></spring:url>
    ...
    <jsp:include page="../includes/menu.jsp"></jsp:include>
      ...
      <spring:hasBindErrors name="horario">
        ...
        <ul>
			...
			<form:form method="post" modelAttribute="horario" action="${urlHorario}save">
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
              <label for="idPelicula" class="control-label">Pelicula</label>
              <form:select path="pelicula.id" items="${peliculas}" itemValue="id" itemLabel="titulo" class="form-control" id="idPelicula"/>
						</div>
					</div>
				</div>
				<div class="row">
